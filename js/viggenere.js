...
key = document.getElementById('floatingPassword').value;

key = key.replace(/ /g,'');

//mensaje

let mess = document.getElementById('floatingInput').value;
...
document.getElementById('texto-ci-o-des').value = newMess;
}else{
...
mess = document.getElementById('floatingInput').value;
